...
from keras.layers import Conv3D, MaxPooling3D, UpSampling3D, Activation, BatchNormalization, Dropout, Concatenate
...
def getUnet3d_4_MGPU(input_shape, pool_size=(2, 2, 2), conv_size=(3, 3, 3),
  ...
  up6 = Concatenate(axis=4, name='conc_6')([up6, conv4])
  ...
  up7 = Concatenate(axis=4, name='conc_7')([up7, conv3])
  ...
  up8 = Concatenate(axis=4, name='conc_8')([up8, conv2])
  ...
  up9 = Concatenate(axis=4, name='conc_9')([up9, conv1])
...
def getUnet3d_3_MGPU(input_shape, pool_size=(2, 2, 2), conv_size=(3, 3, 3),
  ...
  up5 = Concatenate(axis=4, name='conc_5')([up5, conv3])
  ...
  up6 = UpSampling3D(size=pool_size, name='up_6')(conv5)
  up6 = Concatenate(axis=4, name='conc_6')([up6, conv2])
  ...
  up7 = UpSampling3D(size=pool_size, name='up_7')(conv6)
  up7 = Concatenate(axis=4, name='conc_7')([up7, conv1])
